...
const Profile = () => {
  ...
  return (
    <View className="relative flex-1">
      ...
      <View
        className="bg-primary-light absolute bottom-0 h-[70%] w-full translate-y-10 transform"
        style={{
          transform: [{ rotate: '75deg' }],
        }}></View>
      <View
        className="bg-primary-light/40 absolute bottom-0 h-[70%] w-full translate-y-10 transform"
        style={{
          transform: [{ rotate: '85deg' }],
        }}></View>
      <View
        className="bg-primary-light/40 absolute bottom-0 h-[75%] w-full translate-y-10 transform"
        style={{
          transform: [{ rotate: '-77deg' }],
        }}></View>
      <View
        className="bg-primary-light/30 absolute bottom-0 h-[73%] w-full translate-y-10 transform"
        style={{
          transform: [{ rotate: '-85deg' }],
        }}></View>
        ...
        <View className="mb-4 flex-row items-center">
          ...
          <TouchableOpacity className="ml-2 flex-1 rounded-full bg-gray-200 p-3">
            ...
            <ScrollView horizontal showsHorizontalScrollIndicator={false} className="mt-3">
              <TouchableOpacity
                className={`mr-3 rounded-full ${isDarkMode ? 'border border-2 border-white/30' : 'border-primary-dark/30 border border-2'} px-6 py-2`}>
